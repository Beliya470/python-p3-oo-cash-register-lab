...
class TestCashRegister:
    ...
    def reset_register_totals(self):
        self.cash_register.total = Decimal('0')
        self.cash_register_with_discount.total = Decimal('0')
    ...
    def test_add_item(self):
        ...
        assert(self.cash_register.total == Decimal('0.98'))
    ...
    def test_items_list_without_multiples(self):
        ...
        assert(new_register.list_items() == ["eggs", "tomato"])
    ...
    def test_items_list_with_multiples(self):
        ...
        assert(new_register.list_items() == ["eggs", "eggs", "tomato", "tomato", "tomato"])
    ...
    def test_void_last_transaction(self):
        ...
        assert(self.cash_register.total == Decimal('1.97'))
        self.reset_register_totals()
